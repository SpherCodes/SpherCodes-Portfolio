...
const aboutMeText = `I am currently completing my degree in Computer Science and Business Management, 
...
function typeCommand() {
    if (commandIndex < commandText.length) {
        ...
        commandIndex++;
        setTimeout(typeCommand, 400); // Adjust speed by changing the delay
    } else {
        setTimeout(typeAboutMe, 500); // Delay before typing the about-me text
    }
}
